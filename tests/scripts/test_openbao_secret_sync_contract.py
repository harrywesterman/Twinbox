...
WIREDOOR_STEP = REPO_ROOT / "categories" / "talos-cluster" / "steps" / "install-wiredoor-gateway" / "run.sh"
GRAFANA_SECRET = REPO_ROOT / "gitops" / "apps" / "grafana-secret" / "externalsecret.yaml"
WIREDOOR_SECRET = REPO_ROOT / "gitops" / "apps" / "wiredoor-gateway-secret" / "externalsecret.yaml"
TRAEFIK_SECRET = REPO_ROOT / "gitops" / "routes" / "templates" / "traefik-dashboard-externalsecret.yaml"
ROCKETCHAT_STEP = REPO_ROOT / "categories" / "talos-cluster" / "steps" / "install-rocketchat" / "step.yaml"
REMOVED_PLACEHOLDER_STEP = REPO_ROOT / "categories" / "talos-cluster" / "steps" / "install-vaultwarden-app" / "step.yaml"
