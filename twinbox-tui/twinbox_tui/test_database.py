"""
Standalone tests for twinbox_tui.database module.

Run with: python -m pytest test_database.py
"""
...
def test_cluster_deployment_relationship():
...
def test_delete_cluster_cascade():
...
def test_invalid_cluster_operations():
