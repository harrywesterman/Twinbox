...
Talos control planes stay at `2 GB RAM / 10 GB disk`, while worker disks scale from the Proxmox host's free space and Longhorn is scheduled onto workers through the Talos role label.
