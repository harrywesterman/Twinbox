...
```bash
docker pull ghcr.io/harrywesterman/twinbox-manager-api:sha-bbeffc3
docker pull ghcr.io/harrywesterman/twinbox-manager-worker:sha-bbeffc3
docker pull ghcr.io/harrywesterman/twinbox-manager-web:sha-bbeffc3
```
