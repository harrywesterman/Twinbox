...
```bash
docker pull ghcr.io/harrywesterman/twinbox-manager-api:sha-f2ab983
docker pull ghcr.io/harrywesterman/twinbox-manager-worker:sha-f2ab983
docker pull ghcr.io/harrywesterman/twinbox-manager-web:sha-f2ab983
```
