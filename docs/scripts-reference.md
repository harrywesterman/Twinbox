...
- Sizes control-plane VMs at `4 GB RAM / 10 GB disk` and gives workers a default `80%` disk budget from the free space shared across the three Proxmox hosts, with a slider to tune it up or down
