...
All platform services share a single domain name (`ZONE_NAME`) provided by the user during the **Choose Ingress Route** wizard step. The domain flows through the system as follows:
