...
hedgedoc_secret_file="$(mktemp "${TMPDIR:-/tmp}/hedgedoc-bootstrap-XXXXXX")"
hedgedoc_rendered_manifest="$(mktemp "${TMPDIR:-/tmp}/hedgedoc-application-XXXXXX")"
hedgedoc_rendered_deployment="$(mktemp "${TMPDIR:-/tmp}/hedgedoc-deployment-XXXXXX")"
hedgedoc_rendered_ingressroute="$(mktemp "${TMPDIR:-/tmp}/hedgedoc-ingressroute-XXXXXX")"
