...
const QUESTION_STEP_DEFS = [
  {
    ...
    inputs: [
      ...
      { id: 'cpu_cores', label: 'CPU cores', type: 'integer', required: true, min: 1, max: 64, default: 4, help: 'Worker CPU allocation. Control planes stay fixed at 2 vCPU, while workers use this value.' },
      ...
      { id: 'node_prefix_length', label: 'Prefix length', type: 'integer', required: true, min: 1, max: 32, default: '', help: 'CIDR prefix for Talos node addresses.' },
      { id: 'gateway_ip', label: 'Gateway IP', type: 'ipv4', required: true, default: '', help: 'Default gateway for Talos nodes.' },
