...
function cloudttyIconUrl(zoneName) {
  return zoneName ? `https://cloudtty.${zoneName}` : "favicon";
}
...
const DASHY_OFFICIAL_ICON_BY_STEP = new Map([
  ...
  ["install-cloudtty", cloudttyIconUrl],
...
function resolveDashyIcon(step, dashyItem, zoneName) {
  ...
  if (typeof stepIcon === "function") {
    return stepIcon(zoneName);
  }
