...
function localStepIconPath(workspaceRoot, fileBase, extension) {
  if (!workspaceRoot || !fileBase) {
    return "";
  }

  return path.join(workspaceRoot, "portal", "public", "assets", "step-icons", `${fileBase}.${extension}`);
}
...
function resolveLocalStepIconDataUri(workspaceRoot, fileBase) {
  ...
  for (const extension of ["svg", "png"]) {
    const filePath = localStepIconPath(workspaceRoot, normalizedBase, extension);
