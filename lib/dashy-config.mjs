...
const DASHY_OFFICIAL_ICON_BY_STEP = new Map([
  ...
  ["install-cloudtty", "install-cloudtty"],
  ["install-traefik-manager", "install-traefik-manager"],
]);

const DASHY_OFFICIAL_ICON_BY_TITLE = new Map([
  ["Twinbox Wizard", "install-management-consoles"],
  ...
  ["Jitsi", "install-jitsi"],
  ["Traefik Manager", "install-traefik-manager"],
