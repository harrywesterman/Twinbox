...
function localStepIconPaths(workspaceRoot, fileBase, extension) {
  ...
  return [
    path.join(workspaceRoot, "portal", "public", "assets", "step-icons", `${fileBase}.${extension}`),
    path.join(workspaceRoot, "manager-web", "src", "assets", "step-icons", `${fileBase}.${extension}`),
    path.join(workspaceRoot, "manager-web", "public", "assets", "step-icons", `${fileBase}.${extension}`),
  ];
}
...
export function buildDashyConfig({ steps, stepStateById, cluster, excludeStepIds = [], workspaceRoot = "" }) {
