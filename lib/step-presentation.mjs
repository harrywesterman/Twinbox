...
function buildProjectUrlMap() {
  return {
    ...
    "install-seaweedfs-object-store": {
      icon: "🪣",
      project_url: "https://seaweedfs.github.io/seaweedfs/",
    ...
    "provision-netbird-bastion": {
      icon: "🪶",
      project_url: "https://netbird.io/",
      github_url: "https://github.com/netbirdio/netbird",
    },
    "configure-netbird-ingress": {
      icon: "🪶",
      project_url: "https://docs.netbird.io/manage/reverse-proxy",
      github_url: "https://github.com/netbirdio/terraform-provider-netbird",
    },
    "install-netbird-routing-peers": {
      icon: "🪶",
      project_url: "https://docs.netbird.io/use-cases/cloud/routing-peers-and-kubernetes",
      github_url: "https://github.com/netbirdio/netbird",
    },
    "configure-netbird-admin-access": {
      icon: "🪶",
      project_url: "https://docs.netbird.io/manage/network-routes",
      github_url: "https://github.com/netbirdio/netbird",
    },
    ...
    "install-copyparty": {
      icon: "📁",
      project_url: "https://copyparty.eu/",
      github_url: "https://github.com/9001/copyparty",
    },
    "install-freshrss": {
      icon: "📰",
    ...
    "install-stirling-pdf": {
      icon: "📃",
      project_url: "https://www.stirlingtech.org/stirling-pdf",
