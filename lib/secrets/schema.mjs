...
export function buildTalosWorkerSecretBundle(secretRefs = {}) {
  return normalizeSecretBundle({
    files: {
      TWINBOX_TALOS_SECRETS_FILE: buildSecretAttachmentRef(secretRefs.talos_secrets, "secrets.yaml", { optional: true }),
      TWINBOX_TALOSCONFIG_FILE: buildSecretAttachmentRef(secretRefs.talosconfig, "talosconfig", { optional: true }),
      TWINBOX_KUBECONFIG_FILE: buildSecretAttachmentRef(secretRefs.kubeconfig, "kubeconfig", { optional: true }),
    },
  });
}
